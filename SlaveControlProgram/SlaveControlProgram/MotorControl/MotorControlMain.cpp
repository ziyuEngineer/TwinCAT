...
class CMotorControlCtrl : public ITcOCFCtrlImpl<CMotorControlCtrl, CMotorControlClassFactory>
{
public:
	CMotorControlCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("MotorControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CMotorControlCtrl>;
