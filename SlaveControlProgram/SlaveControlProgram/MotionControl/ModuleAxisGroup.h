...
///<AutoGeneratedContent id="InterfaceMembers">
	...
	virtual HRESULT TCOMAPI RequestFault();
	virtual HRESULT TCOMAPI SetAxisVelLoopKp(SHORT axis, double value);
	virtual HRESULT TCOMAPI SetAxisVelLoopTn(SHORT axis, double value);
	virtual HRESULT TCOMAPI SetAxisPosLoopKv(SHORT axis, double value);
	virtual HRESULT TCOMAPI GetAxisVelLoopKp(SHORT axis, double& value);
	virtual HRESULT TCOMAPI GetAxisVelLoopTn(SHORT axis, double& value);
	virtual HRESULT TCOMAPI GetAxisPosLoopKv(SHORT axis, double& value);
	virtual HRESULT TCOMAPI RequestMovingToTargetPos(bool* axis, double* pos);
