...
class CMotionControlCtrl : public ITcOCFCtrlImpl<CMotionControlCtrl, CMotionControlClassFactory>
{
public:
	CMotionControlCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("MotionControl: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CMotionControlCtrl>;
