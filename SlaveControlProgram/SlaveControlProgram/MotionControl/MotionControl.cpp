...
bool CMotionControl::InitializePlcRpc()
{
	...
	if (m_spPLC_PanelProcess != NULL)
	{
		...
		CCommandController::m_pPanelProcess = m_spPLC_PanelProcess;
	}
...
bool CMotionControl::InitializeOtherModuleRpc()
{
	...
	{
		CCommandController::m_pSpindleInterface = m_spModuleSpindle_Interface;
		CCommandController::m_pAxisGroupInterface = m_spModuleAxisGroup_Interface;
		is_initialized = true;
	}
...
HRESULT CMotionControl::ExecuteCommandsContinuously(SHORT n_min_data_start, SHORT& buffer_size, char op_mode)
{
	HRESULT hr = S_OK;
	...
	event_continuous_execution.axisgroupOpMode = static_cast<OpMode>(op_mode);
...
HRESULT CMotionControl::EnterRecoveryState(bool is_entered)
{
	...
	m_Controller.RequestAxisGroupRecoveryState(is_entered);
	return hr;
}
