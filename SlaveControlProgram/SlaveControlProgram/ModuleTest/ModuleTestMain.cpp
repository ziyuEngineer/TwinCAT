...
class CModuleTestCtrl : public ITcOCFCtrlImpl<CModuleTestCtrl, CModuleTestClassFactory>
{
public:
	CModuleTestCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("ModuleTest: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CModuleTestCtrl>;
